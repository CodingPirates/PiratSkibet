...
@inject(['model'])
export default class Like extends Widget {
    ...
    handleClick = debounce(() => {
        ...
        let request = {type: 'like', react: (this.state.reacted)?0:1};
    ...
    renderWidget() {
        return (
            <React.Fragment>
                ...
                <Auth.Can permission={this.permission} negate={true} >
                    {this.renderInner(false)}
                </Auth.Can>
            </React.Fragment>
        );
    }
