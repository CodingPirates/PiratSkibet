...
class ResetPassword extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->greeting(Lang::get('emails.greetings.casual'))
            ->line(Lang::get('emails.reset_password.line_1'))
            ->line(Lang::get('emails.reset_password.line_2'))
            ->action(Lang::get('emails.reset_password.action'), url(config('app.url').route('app.password_reset.reset', ['token' => $this->token, 'email' => $notifiable->getEmailForPasswordReset()], false)))
